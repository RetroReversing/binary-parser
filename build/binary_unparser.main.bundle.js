(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.binary_unparser = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
//========================================================================================
// Globals
//========================================================================================
var vm = require("vm");
...
},{"./context":3,"vm":13}],2:[function(require,module,exports){
"use strict";
...
class UnParser {
  constructor(obj) {
    this.options = {};
    this.constructorFn = _lodash.noop;
  ...
  generateChoice(ctx) {
    var tag = ctx.generateOption(this.options.tag); // if (this.varName) {
    //   ctx.pushCode("{0} = {};", ctx.generateVariable(this.varName));
    // }
  ...
  generateChoiceCase(ctx, varName, type) {
    if (typeof type === "string") {
      if (!aliasRegistry[type]) {// ctx.pushCode(
        //   "{0} = buffer.read{1}(offset);",
        //   ctx.generateVariable(this.varName),
        //   NAME_MAP[type]
        // );
...
},{"./binary_parser":1,"./context":3,"lodash":11,"vm":13}],3:[function(require,module,exports){
//========================================================================================
// class Context
//========================================================================================
...
Object.defineProperty(exports, "Parser", {
  enumerable: true,
  get: function () {
    return _binary_parser.default;
  }
});
Object.defineProperty(exports, "FileUnparser", {
  enumerable: true,
  get: function () {
    return _binary_unparser.FileUnparser;
  }
});
Object.defineProperty(exports, "ReactUnparser", {
  enumerable: true,
  get: function () {
    return _binary_unparser.ReactUnparser;
  }
});
exports.md5 = exports.Buffer = void 0;

var _binary_parser = _interopRequireDefault(require("./lib/binary_parser"));

var _binary_unparser = require("./lib/binary_unparser");
...
},{"./lib/binary_parser":1,"./lib/binary_unparser":2,"buffer/":6,"md5":12}],5:[function(require,module,exports){
'use strict'
...
},{"base64-js":5,"ieee754":9}],7:[function(require,module,exports){
var charenc = {
  // UTF-8 encoding
  utf8: {
...
},{"charenc":7,"crypt":8,"is-buffer":10}],13:[function(require,module,exports){
