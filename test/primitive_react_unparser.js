...
var ReactUnparser = require("../lib/binary_unparser").ReactUnparser;

describe("Primitive React UNparser", function() {
  describe("Primitive React UNparsers", function() {
    it("should nothing React", function() {
      ...
      assert.deepEqual(unParser.unparse(result, []), []);
    });
    ...
    it("should UNparse integer types React", function() {
      ...
      var buffer = Buffer.from([0x00, 0xd2, 0x04, 0x01,0x02, 0x00, 0xbc, 0x61, 0x4e]);
